const Us = () =>{
    return(
        ...
        <div className="container text-white">
            ...
            <p>
                En nuestro local vas a encontrar una amplia variedad de artículos. Nos esforzamos día a día por brindar un servicio completo y confiable, adaptándonos a las necesidades del barrio y acompañando a las familias que nos eligen. Ser parte de esta comunidad nos llena de orgullo, y trabajamos con compromiso para seguir siendo el almacén de confianza de todos los vecinos de Liniers.
            </p>
        </div>
        </>
    )
